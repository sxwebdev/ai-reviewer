...
func vecCases() []vecCase {
	return []vecCase{
		...
		{"slack_commands_total", prometheus.Labels{"team": "payments", "scope": "mine", "result": ResultOK},
			func(l prometheus.Labels) error { _, err := SlackCommandsTotal.GetMetricWith(l); return err }},
